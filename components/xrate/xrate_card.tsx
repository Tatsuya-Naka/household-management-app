...
export default function XRateCard({ currencyType, onSubmit, defaultValue, notTextAllowed }: XRateCardProps) {
      ...
      <div className={`rounded-lg bg-transparent cursor-pointer mb-3 relative z-10`}>
        ...
        {isClicked && (
          <div className="absolute top-10 left-0 right-0 z-10 ">
            <SelectCurrencyType current={currencyType} setIsClicked={setIsClicked} />
          </div>
        )}
      </div>
